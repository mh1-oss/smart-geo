                        ...
                        <div className="flex justify-between items-end border-b-2 border-slate-900 pb-6 mb-8">
                            <div>
                                ...
                                {results.isAiGenerating && (
                                    <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-700 text-xs font-bold rounded-full animate-pulse border border-indigo-100">
                                        <span className="w-2 h-2 bg-indigo-500 rounded-full animate-bounce"></span>
                                        <span>AI is enhancing this report... (Background)</span>
                                    </div>
                                )}
                            </div>
